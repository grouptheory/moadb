...
namespace signal
{
	public class TrajectoryFactory_NumBids : AbstractPassiveTrajectoryFactory
	{
		private static string NAME = "NumBids";
		...
		public TrajectoryFactory_NumBids(double timeQuantum, double historicalBias) : base(timeQuantum, historicalBias) {
			_name = NAME;
			reset();
			SingletonLogger.Instance().DebugLog(typeof(TrajectoryFactory_Price), "TrajectoryFactory_NumBids");
		}
	}
}
