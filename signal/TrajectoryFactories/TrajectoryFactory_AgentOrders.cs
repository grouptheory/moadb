...
namespace signal
{
	public class TrajectoryFactory_AgentOrders : AbstractAgentTrajectoryFactory
	{
		private static string NAME = "AgentOrders";
		...
		public override void SimulationEndNotification() {
			MyTrajectory.add(TimeNow, _agent.NumBids+_agent.NumAsks );
		}
		...
		public TrajectoryFactory_AgentOrders(IAgent agent, double timeQuantum, double historicalBias) : base(agent, timeQuantum, historicalBias) {
			_name = NAME;
			reset();
		}
	}
